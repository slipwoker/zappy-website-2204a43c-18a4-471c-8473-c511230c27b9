document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    const validateField = function (field) {
      ...
      if (field.minLength && field.minLength > 0 && value.trim() !== '') {
  ...
  if (!prefersReducedMotion && elementsToAnimate.length > 0) {
    if ('IntersectionObserver' in window) {
      ...
      elementsToAnimate.forEach(function (el, index) {
        ...
        if (!el.dataset.animateDelay) {
          const siblings = el.parentNode ? el.parentNode.querySelectorAll('.' + OBSERVE_CLASS) : [];
          let siblingIndex = 0;
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "Evolution משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '2204a43c-18a4-471c-8473-c511230c27b9',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '2204a43c-18a4-471c-8473-c511230c27b9';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '2204a43c-18a4-471c-8473-c511230c27b9';
